!(function(a, b, c, d) {
    ...
    (a.quiz = function(b, d) {
        ...
        (e.methods = {
            init: function() {
                e.methods.setup(),
                    a(c).on("dblclick", i, function(a) {
                        a.preventDefault(), e.methods.start();
                    }),
                    a(c).on("dblclick", j, function(a) {
                        a.preventDefault(), e.methods.home();
                    }),
                    a(c).on("dblclick", ".answers a", function(a) {
                        a.preventDefault(), e.methods.answerQuestion(this);
                    }),
                    a(c).on("dblclick", "#quiz-next-btn", function(a) {
                        a.preventDefault(), e.methods.nextQuestion();
                    }),
                    a(c).on("dblclick", "#quiz-finish-btn", function(a) {
                        a.preventDefault(), e.methods.finish();
                    }),
                    a(c).on("dblclick", "#quiz-restart-btn, #quiz-retry-btn", function(a) {
            ...
            nextQuestion: function() {
                ...
                a(".active-question").hide().removeClass("active-question").next(".question-container").show().addClass("active-question"),
                    a("#quiz-controls").hide(),
                    ++p === g && (a("#quiz-next-btn").hide(), a("#quiz-finish-btn").show()),
                    e.methods.updateCounter(),
    ...
    (a.quiz.defaultOptions = {
        ...
        resultsFormat: " ¡Obtuviste %score puntos de %total Correctos!",
